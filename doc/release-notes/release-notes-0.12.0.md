...
Then, to tunnel a SSL connection on 27612 to a RPC server bound on localhost on port 17612 do:

    stunnel -d 27612 -r 127.0.0.1:17612 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:7612/
        ProxyPassReverse http://127.0.0.1:7612/

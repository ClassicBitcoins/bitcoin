...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\", \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\"")
            + HelpExampleRpc("getaccount", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\"")
        );
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" 0") +
            "\nThe amount with at least 6 confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\":0.01,\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\":0.01,\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\":0.01,\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\":0.02}\" 1 \"\" \"[\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\",\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"\", \"{\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\":0.01,\\\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\\\":0.02}\", 6, \"testing\"")
        );
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwallet->IsCrypted() && (request.fHelp || request.params.size() != 0)) {
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"12yEgn2vEVT8rPWtYaCy5wBqY1W4jFPd5R\" 1.0") +
